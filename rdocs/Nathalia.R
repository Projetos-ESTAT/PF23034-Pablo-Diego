...
banco_num <- banco %>%
  ...
  select(q37,q38,q39,q40,q41,q42,q43,q44,q45,q46,q47,q48)
...
q37$`2 - A equipe da DPDI possui qualificação profissional e acadêmica em gestão da informação.` <- 
  factor(q37$`2 - A equipe da DPDI possui qualificação profissional e acadêmica em gestão da informação.`,
         levels = ordem)
...
q38$`3. A equipe da DPDI É incentivada a buscar qualificação e atualização profissional em relação à gestão da informação.` <- 
  factor(q38$`3. A equipe da DPDI É incentivada a buscar qualificação e atualização profissional em relação à gestão da informação.`,
         levels = ordem)
...
q39$`4. A equipe da DPDI possui composição multidisciplinar adequada para desenvolver as atividades da gestão da informação na Área de planejamento, desenvolvimento e informação.` <- 
  factor(q39$`4. A equipe da DPDI possui composição multidisciplinar adequada para desenvolver as atividades da gestão da informação na Área de planejamento, desenvolvimento e informação.`,
         levels = ordem)
...
q40$`5. A equipe da DPDI possui número de servidores suficiente para desenvolver as atividades da gestão da informação na Área de planejamento, desenvolvimento e informação.` <- 
  factor(q40$`5. A equipe da DPDI possui número de servidores suficiente para desenvolver as atividades da gestão da informação na Área de planejamento, desenvolvimento e informação.`,
         levels = ordem)
...
q41$`1 - O processo de gestão da informação na Área de planejamento, desenvolvimento e informação, desde a coleta até o compartilhamento e análise, é eficaz.` <- 
  factor(q41$`1 - O processo de gestão da informação na Área de planejamento, desenvolvimento e informação, desde a coleta até o compartilhamento e análise, é eficaz.`,
         levels = ordem)
...
q42$`2. O processo de coleta, armazenamento e gestão de informações relevantes feito pela Área de planejamento, desenvolvimento e informação é satisfatório.` <- 
  factor(q42$`2. O processo de coleta, armazenamento e gestão de informações relevantes feito pela Área de planejamento, desenvolvimento e informação é satisfatório.`,
         levels = ordem)
...
q43$`3. Os fluxos de compartilhamento de informações na Área de planejamento, desenvolvimento e informação é satisfatório.` <- 
  factor(q43$`3. Os fluxos de compartilhamento de informações na Área de planejamento, desenvolvimento e informação é satisfatório.`,
         levels = ordem)
...
q44$`4. A Área de planejamento, desenvolvimento e informação possui indicadores e métricas claras para medir, avaliar e melhorar sistematicamente a eficácia de seus processos de gestão da informação.` <- 
  factor(q44$`4. A Área de planejamento, desenvolvimento e informação possui indicadores e métricas claras para medir, avaliar e melhorar sistematicamente a eficácia de seus processos de gestão da informação.`,
         levels = ordem)
...
q45$`1. A Área de planejamento, desenvolvimento e informação possui sistemas e tecnologias adequados para gerenciar e compartilhar informações de maneira eficiente.` <- 
  factor(q45$`1. A Área de planejamento, desenvolvimento e informação possui sistemas e tecnologias adequados para gerenciar e compartilhar informações de maneira eficiente.`,
         levels = ordem)
...
q46$`2. A Área de planejamento, desenvolvimento e informação utiliza tecnologias de informação e comunicação de maneira adequada para apoiar o processo de gestão da informação.` <- 
  factor(q46$`2. A Área de planejamento, desenvolvimento e informação utiliza tecnologias de informação e comunicação de maneira adequada para apoiar o processo de gestão da informação.`,
         levels = ordem)
...
q47$`3. O impacto do uso de tecnologias de informação na gestão da informação na Área de planejamento, desenvolvimento e informação é positivo.` <- 
  factor(q47$`3. O impacto do uso de tecnologias de informação na gestão da informação na Área de planejamento, desenvolvimento e informação é positivo.`,
         levels = ordem)
...
q48$`4. A Área de planejamento, desenvolvimento e informação utiliza abordagem planejada e sistemática para selecionar dados e informações úteis.` <- 
  factor(q48$`4. A Área de planejamento, desenvolvimento e informação utiliza abordagem planejada e sistemática para selecionar dados e informações úteis.`,
         levels = ordem)
...
ggplot(q48) +
  ...
  labs(x = "Questão 48", y = "Frequência") +
  theme_estat()
#ggsave("colunas-q48.pdf", width = 158, height = 93, units = "mm")
